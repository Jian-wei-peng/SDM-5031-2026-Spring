...
def build_parser():
    ...
    parser.add_argument("--K", type=int, default=128, help="Number of z-conditioned strategy rollouts per instance.")
    ...
    parser.add_argument("--force_first_move", type=str2bool, default=False)
    parser.add_argument(
        "--train_objective",
        choices=("best_of_k", "pomo"),
        default="best_of_k",
        help="best_of_k uses only the best strategy rollout log_prob; pomo keeps the all-rollout REINFORCE loss.",
    )
    return parser
...
def build_params(args):
    ...
    env_params = {
        ...
        'pomo_size': first_size if args.force_first_move else args.K,
    }
    optimizer_params = {
        'optimizer': {
            'lr': args.lr,
...
def main():
    ...
    logger.info("PolyNet-style free-start best-of-K training")
