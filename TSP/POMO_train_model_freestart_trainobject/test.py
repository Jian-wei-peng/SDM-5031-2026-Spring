...
DEFAULT_MODEL_DIR = os.path.join(SCRIPT_DIR, "result", "saved_tsp100_model2_longTrain")
...
def build_parser():
    ...
    parser.add_argument(
        ...
        type=int,
        default=None,
        help="Number of free-start strategy rollouts. Defaults to the checkpoint value when available.",
    )
