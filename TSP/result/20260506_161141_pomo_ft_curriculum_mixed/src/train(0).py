...
def build_parser():
    ...
    parser.add_argument("--reset_epoch", type=str2bool, default=True)       # 是否重置训练轮数计数器
    ...
    # 日志与评估
    parser.add_argument("--model_save_interval", type=int, default=50)      # 模型保存间隔（epoch）
    parser.add_argument("--img_save_interval", type=int, default=50)        # 图像保存间隔（可能是损失图等）
