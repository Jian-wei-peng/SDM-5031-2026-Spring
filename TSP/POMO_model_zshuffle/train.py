...
def build_parser():
    parser = argparse.ArgumentParser(
        description="POMO model-side ablation: z residual with random z assignment during training."
    )
    parser.add_argument("--exp_name", default="pomo_model_zshuffle_stage1")
...
def main():
    ...
    logger.info("POMO model-side z-shuffle ablation: fixed-size uniform training with PolyNet residual")
