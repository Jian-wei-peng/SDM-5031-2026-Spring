  ...
  \begin{columns}[T,totalwidth=\textwidth]
    \begin{column}{0.54\textwidth}
      ...
      \begin{itemize}
        ...
        \item Use the public validation set to iterate and compare against the baseline
...
\end{lstlisting}
    ...
    \begin{column}{0.48\textwidth}
      \begin{block}{Bundled assets}
        \begin{itemize}
          \item Public validation set: \texttt{TSP/data/val}
          \item Baseline checkpoint: {\scriptsize\texttt{checkpoint-3000.pt}}
          \item Standardized evaluation entrypoint: \texttt{TSP/POMO/test.py}
        \end{itemize}
      \end{block}
